...
ridge_model= pickle.load(open('C:/Programming/AI_ML/Project_August/model/ridge.pkl','rb'))
scaler = pickle.load(open('C:/Programming/AI_ML/Project_August/model/scaler.pkl' ,'rb'))
